...
without the tiered router, that bundle costs about **36.1x** the
context this kit loads at session start. Loading the full doctrine reference is
an upper-bound ceiling at **158.3x**. This measures context-loading
...
|---|---:|---:|---:|
| Naive full reference (resident) | 151 | 844111 | 211027 |
| Realistic single-tier (no router) | 16 | 192737 | 48184 |
| Kit session-start (tier-0) | 2 | 5332 | 1333 |

## Ratios

- **Typical contribution, realistic / kit:** 36.1x
- **Upper-bound ceiling, naive / kit:** 158.3x
