...
without the tiered router, that bundle costs about **37.0x** the
context this kit loads at session start. Loading the full doctrine reference is
an upper-bound ceiling at **160.5x**. This measures context-loading
...
|---|---:|---:|---:|
| Naive full reference (resident) | 152 | 855921 | 213980 |
| Realistic single-tier (no router) | 16 | 197222 | 49305 |
| Kit session-start (tier-0) | 2 | 5332 | 1333 |

## Ratios

- **Typical contribution, realistic / kit:** 37.0x
- **Upper-bound ceiling, naive / kit:** 160.5x
