...
**Name:** Claude, Kiro, and Codex (v1 build panel)
...
- **Skill mechanics that emerged inside this kit** (the four-cell
  ...
  own contributions.
- **Cameron's personal context** (the WAL incident, the IIP proof
  point). Not citations; they are the kit's own provenance.
