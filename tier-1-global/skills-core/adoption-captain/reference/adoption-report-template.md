...
.compound-ai/tier-1-global/skills-core/...   (kit content)
.compound-ai/tier-2-capabilities/skills/...  (kit content)
...
| .cursorrules | ./.cursorrules | SKIPPED (operator declined) | -- |
...
Date: 2026-04-01
Operator: jsmith
Host project: /Users/jsmith/projects/task-board
Kit version: v2.5.0
...
.compound-ai/discovery-report.md
.compound-ai/preserve-map.md
.compound-ai/tier-1-global/skills-core/ (subset: 5 adopted skills)
.compound-ai/tier-2-capabilities/skills/ (subset: 4 adopted skills)
.compound-ai/docs/FIELD-GUIDE.md
```
