...
Tier 1 infrastructure skill. Use on plans, documents, code, decisions, or releases. Triggers: "set up a panel", "convene a panel", "multi-agent review", "second opinion", "panel this".
